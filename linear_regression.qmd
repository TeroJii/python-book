...
Let's predict the happiness score for the first five countries in the dataset. The results are displayed in @tbl-predictions.
...
X_new = happiness[['GDP per capita']].head()
...
preds_df = pd.DataFrame({
    ...
    'Actual score': happiness['Score'].head()
})
