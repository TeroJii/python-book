...
Above we used our `seaborn` knowledge to visualize the linear relationship. However, in order to actually fit the model shown in @eq-linear, we need to use the `LinearRegression` class from `scikit-learn`.
