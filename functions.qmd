...
In most cases, you can also use the `help()` function to get more information about a method. This will return a description of the method, as well as the arguments it takes.
