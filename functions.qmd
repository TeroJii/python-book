...
You might have noticed, but we have been using built-in functions in the previous chapters already. Python ships with a number of functions that are readily at your disposal. If you want or need to build your own, that is also possible. 
...
Using basic functions is dead simple. Usually the function has some parameters which need values as input. Let's try the functions above to get a feel for how they work:
