...
Python 3.6 introduced a new way of formatting strings which are referred to as f-strings. Let's show how they work with a simple example:
...
That's it. We have covered the basics of Python data types. 
Now that this is behind us, we are ready to move on to more advanced and interesting topics. In the upcoming chapter, we will cover control flow statements in Python.