...
#| fig-cap: The confusion matrix shows the true class labels against the predicted classes for our test data. The numeric values indicate the number of cases in each category. This means that the diagonal elements correspond to correctly classified cases.
#| code-fold: false
