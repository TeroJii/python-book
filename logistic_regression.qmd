...
sns.lmplot(data=bc_data, x='Uniformity_of_cell_size', y='Class', logistic=True, ci=95, height=4, aspect=1.5)
```	
...
sns.histplot(data=bc_data, x='Uniformity_of_cell_size', hue='Class', bins=20, kde=True)
```

This really makes it clear why the logistic regression line is shaped the way it is.
