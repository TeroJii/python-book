...
We can also filter the DataFrame based on a specific column. Let's say we want to find all the elements in the 'col1' column that are greater than 0:

Let's say we want to find people over the age of 25:
