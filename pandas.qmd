...
It quite common in data science to filter data based on some condition. We can use the bracket notation to filter the data. Let's say we want to find people over the age of 25:
